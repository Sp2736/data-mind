...
class Dataset(Base):
    ...
    cleaned_path: Mapped[str | None] = mapped_column(String, nullable=True)
...
class DatasetProfile(Base):
    ...
    system_run_id: Mapped[str | None] = mapped_column(String, ForeignKey("analysis_runs.id", ondelete="SET NULL"), nullable=True)

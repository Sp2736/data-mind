          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 shrink-0 self-stretch sm:self-auto justify-end">
              <button 
                ...
                className="inline-flex items-center justify-center gap-1.5 px-4 py-2 border border-stone-200 dark:border-stone-850 bg-white dark:bg-stone-900 rounded-xl text-xs font-semibold text-stone-600 dark:text-stone-400 hover:bg-stone-50 dark:hover:bg-stone-850 cursor-pointer transition-colors"
              >
              ...
              <Link
                ...
                className="inline-flex items-center justify-center gap-1.5 px-5 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl text-xs font-semibold shadow-md shadow-indigo-100 dark:shadow-none hover:shadow-lg transition-all cursor-pointer"
              >
                          ...
                          <table className="w-full text-left border-collapse text-[10px]">
                            ...
                            <tbody>
                              {visual.chart_config.table_rows?.map((row, rIdx) => (
                                <tr key={rIdx} className="border-b border-stone-100 dark:border-stone-800/40 hover:bg-stone-50/60 last:border-b-0 font-medium">
                                  {visual.chart_config.table_headers?.map((header, hIdx) => (
